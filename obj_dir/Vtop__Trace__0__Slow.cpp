...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedFst* tracep) {
    ...
    tracep->declBit(c+5,"soda_o",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1);
    tracep->declBus(c+6,"change_o",-1,FST_VD_OUTPUT,FST_VT_VCD_WIRE, false,-1, 2,0);
    tracep->declBit(c+7,"tmp_soda",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1);
    tracep->declBus(c+8,"tmp_change",-1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 2,0);
    {
        const char* __VenumItemNames[]
        = {"IDLE", "NICKEL", "DIME", "TEMP"};
        const char* __VenumItemValues[]
        = {"0", "1", "10", "11"};
        tracep->declDTypeEnum(1, "design_main.state_e", 4, 2, __VenumItemNames, __VenumItemValues);
    }
    tracep->declBus(c+9,"state_next",1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 1,0);
    tracep->declBus(c+10,"state_current",1, FST_VD_IMPLICIT,FST_VT_SV_LOGIC, false,-1, 1,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+7,(((2U & (IData)(vlSelf->top__DOT__dut__DOT__state_current))
                            ? ((1U & (IData)(vlSelf->top__DOT__dut__DOT__state_current))
                                ...
                                : ((IData)(vlSelf->dime_i) 
                                   | (IData)(vlSelf->quarter_i)))
                            : (IData)(vlSelf->quarter_i))));
    bufp->fullCData(oldp+8,(vlSelf->top__DOT__dut__DOT__tmp_change),3);
    bufp->fullCData(oldp+9,(vlSelf->top__DOT__dut__DOT__state_next),2);
    bufp->fullCData(oldp+10,(vlSelf->top__DOT__dut__DOT__state_current),2);
}
